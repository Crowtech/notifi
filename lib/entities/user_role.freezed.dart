...
class SuperAdmin implements UserRole {
  const SuperAdmin();

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is SuperAdmin);
  }
...
class OrgAdmin implements UserRole {
  const OrgAdmin();

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is OrgAdmin);
  }
...
class Manager implements UserRole {
  const Manager();

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Manager);
  }
