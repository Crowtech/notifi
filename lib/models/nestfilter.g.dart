...
NestFilter _$NestFilterFromJson(Map<String, dynamic> json) => NestFilter(
  orgIdList:
      (json['orgIdList'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList() ??
      const [],
  resourceCodeList:
      (json['resourceCodeList'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  resourceIdList:
      (json['resourceIdList'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList() ??
      const [],
  targetIdList:
      (json['targetIdList'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList() ??
      const [],
  deviceCodeList:
      (json['deviceCodeList'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
