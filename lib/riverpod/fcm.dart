...
class FcmFetcher extends Notifier<String> {
...
void init({ List<String>? topics, FirebaseOptions? options}) async
{
    ...
    if (settings.authorizationStatus == AuthorizationStatus.authorized) {
      ...
      logNoStack
          .i('FIREBASE: User declined or has not accepted messaging permission');
    }
    logNoStack
        .i('FIREBASE: User granted permission: ${settings.authorizationStatus}');
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      logNoStack.i(
          "FIREBASE: INCOMING NOTIFICATION:!nTITLE: ${notification.title}\nBODY: ${notification.body}");
...
final fcmProvider =
    NotifierProvider<FcmFetcher, String>(FcmFetcher.new);
