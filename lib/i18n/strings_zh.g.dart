...
class TranslationsZh extends Translations {
	...
	@override String get previous => '以前的';
	...
	@override String get subject_capitalized => '主题';
	...
	@override String get topic => '话题';
	@override String get topic_capitalized => '话题';
...
class _TranslationsFormZh extends TranslationsFormEn {
	...
	// Translations
	@override String authorized({required Object item}) => '我声明我被授权创建此${item}';
	@override String validating({required Object field}) => '请等待${field}验证完成';
	...
	@override String get message_capitalized => '信息';
	@override String get message_validation => '请输入有效信息';
	@override String get message_hint => '输入消息';
	@override String get subject => '主题';
	@override String subject_validation({required Object item}) => '请输入有效的${item}，限制为 250 个字符';
	@override String get subject_hint => '输入主题';
	@override String get template => '模板';
	...
	@override String get topic => '话题';
	@override String get topic_capitalized => '话题';
	@override String topic_validation({required Object item}) => '请输入有效的${item}';
	@override String topic_hint({required Object item}) => '输入${item}';
	...
	@override String get username_capitalized => '用户名';
	@override String get username_validation => '请输入有效的用户名';
	@override String get username_hint => '输入用户名';
...
// Path: invite
class _TranslationsInviteZh extends TranslationsInviteEn {
	_TranslationsInviteZh._(TranslationsZh root) : this._root = root, super.internal(root);
...
extension on TranslationsZh {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'form.authorized': return ({required Object item}) => '我声明我被授权创建此${item}';
			case 'form.validating': return ({required Object field}) => '请等待${field}验证完成';
			...
			case 'form.message': return '信息';
			case 'form.message_capitalized': return '信息';
			case 'form.message_validation': return '请输入有效信息';
			case 'form.message_hint': return '输入消息';
			case 'form.subject': return '主题';
			case 'form.subject_validation': return ({required Object item}) => '请输入有效的${item}，限制为 250 个字符';
			case 'form.subject_hint': return '输入主题';
			...
			case 'form.topic': return '话题';
			case 'form.topic_capitalized': return '话题';
			case 'form.topic_validation': return ({required Object item}) => '请输入有效的${item}';
			case 'form.topic_hint': return ({required Object item}) => '输入${item}';
			...
			case 'form.username': return '用户名';
			case 'form.username_capitalized': return '用户名';
			case 'form.username_validation': return '请输入有效的用户名';
			case 'form.username_hint': return '输入用户名';
			...
			case 'response.save': return '节省';
			case 'response.send': return '发送';
			...
			case 'response.sure': return '你确定吗';
			...
			case 'subject_capitalized': return '主题';
			...
			case 'topic_capitalized': return '话题';
